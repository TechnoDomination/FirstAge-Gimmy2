...
public enum Positions {
    ...
    ShootingPositionsRed(new Vector2d(40, 30), PI*.25),
    RedIntakeTape1Start(new Vector2d(40, 15), PI*0.5),
    RedIntakeTape1End(new Vector2d(73.5, 15), PI*0.5),
    ParkPositionsRed(new Vector2d(60, 25), PI*0.25),
    TurningRed(new Vector2d(0,  90), PI*0.25),
    NewTurningRed(new Vector2d(12,-48), PI*0.125),
    ...
    ShootingPositionsBlue(new Vector2d(-40, 15), PI*-0.25),
    BlueIntakeTape1Start(new Vector2d(-40, 15), PI*-0.5),
    BlueIntakeTape1End(new Vector2d(73.5, 15), PI*-0.5),
    ParkPositionsBlue(new Vector2d(-60, 15), PI*-0.25),
    TurningBlue(new Vector2d(0,  70), PI*-0.25),
    NewTurningBlue(new Vector2d(-12, -48),PI*-0.125),
