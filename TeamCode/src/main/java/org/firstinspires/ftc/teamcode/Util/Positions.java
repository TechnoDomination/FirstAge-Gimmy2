...
public enum Positions {
    ...
    NewTurningRed(new Vector2d(12,-42), PI*0.115),
    ...
    BlueIntakeTape1End(new Vector2d(-52.5, -5), PI*-0.5),
    BlueIntakeTape3Start(new Vector2d(-20, -30), PI*-0.5),
    BlueIntakeTape3End(new Vector2d(-52, -30), PI*-0.5),
    ParkPositionsBlue(new Vector2d(-50, 0), PI*-0.25),
    TurningBlue(new Vector2d(0,  70), PI*-0.25),
    NewTurningBlue(new Vector2d(-12, -48),PI*-0.115),
