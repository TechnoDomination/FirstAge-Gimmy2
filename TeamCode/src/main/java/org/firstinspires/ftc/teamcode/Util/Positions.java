...
public enum Positions {
    ...
    NewTurningRed(new Vector2d(11.7,-37), PI*0.15),
    NewTurningRed2(new Vector2d(11.7,-37), PI*0.15),
    ...
    ShootingBlueFirstShot(new Vector2d(-20, 12), PI*-0.15),
    ...
    NewTurningBlue(new Vector2d(-8, -48),PI*-0.15),
    NewTurningBlue2(new Vector2d(-8, -48),PI*-0.15),
